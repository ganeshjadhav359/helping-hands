...
<?php
  ...
  $sql2="SELECT u.full_name,u.emailid,p.sr_no,u.mobile,p.field,p.message,p.mtime,p.title FROM userdata u,postfeed p WHERE p.uid=u.uid AND p.uid='$uid'";
    ...
    <div class="container">
           ...
           <?php while($row=mysqli_fetch_assoc($result2)): ?> 
                ...
                <div class="profile1">
                  ...
                  <div class="info" style="height: 40px;border:none; border-top:1px solid #d9d9d9;">
                             <!-- <?php echo $row['sr_no'];?> -->
                             <div>
                             <p style="padding:10px 0px 0px 10px;float: left;">Contact No.<?php echo $row['mobile']; ?></p>
                             </div>
                             <a class="dbutton" href="delete.php?sr_no=<?php echo $row['sr_no'];?>">Delete</a>
                ...
                <ul>
                     ...
                     <a class="rButton" style="float:left" href="childeducation.php">Child Education</a>
                      <a class="rButton" style="float:left" href="disaster.php">Disaster Management and relief</a>
                       ...
                       <a class="rButton" style="float:left" href="animal.php">Animals</a>
