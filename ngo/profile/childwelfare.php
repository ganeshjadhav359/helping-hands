...
if(!isset($_SESSION['uid'])){
  ...
  $sql2="SELECT u.full_name,u.emailid,u.mobile,p.field,p.message,p.mtime,p.title FROM userdata u,postfeed p WHERE p.uid=u.uid  AND p.field ='Child Welfare'";
                ...
                <ul>
                     ...
                     <a class="rButton" style="float:left" href="childeducation.php">Child Education</a>
                      <a class="rButton" style="float:left" href="disaster.php">Disaster Management and relief</a>
                       ...
                       <!-- <a class="rButton" style="float:left ;" href="#">Volunteer</a> -->
