...
if(!isset($_SESSION['uid'])){
  ...
  $sql2="SELECT u.full_name,u.emailid,u.mobile,p.field,p.message,p.mtime,p.title FROM userdata u,postfeed p WHERE p.uid=u.uid";
        ...
        <header>
         <div class="box">
            ...
            <ul>
               ...
               <a class="Button" href="mypost.php" style="float:right;"  >My Posts</a>
    ...
    <div class="container">
            <div class="left_col">
                ...
                <div class="post">
                    ...
                    <a class="pButton" href="javascript:show('post1')" style="margin:0px 0px 20px 50px ;text-align:center;">post</a>
                   </div>
                </div>
            </div> 
            <div class="middle">
                ...
                <div class="profile1">
                  ...
                  <div class="message">
                    <div class="min">
                       ...
                       ?>
                         <p> <span style="color:green;font-size:15px"><?php echo $date; ?></span>
                          <p style="overflow:auto;"><?php echo $row['message']; ?></p>
        ...
        <div class="profile" style="min-height: 200px; width:80%;">
              <div class="box">
                <ul>
                     ...
                     <a class="rButton" href="/ngo/profile/childwelfare.php" style="float:left;"  >Child Welfare</a>
                     <a class="rButton" style="float:left" href="/ngo/profile/childeducation.php">Child Education</a>
                      <a class="rButton" style="float:left" href="/ngo/profile/disaster.php">Disaster Management and relief</a>
                       <a class="rButton" style="float:left" href="/ngo/profile/environment.php">Environment</a>
                       <a class="rButton" style="float:left;border-bottom:1px solid #b18cd9;" href="/ngo/profile/animal.php">Animals</a>
                       <!-- <a class="rButton" style="float:left ;border-bottom:1px solid #b18cd9;" href="volunteer.php">Volunteer</a> -->
...
<div class="outp" style="float:left;">
  ...
  <div class="top">
      <div style="color:#fff;padding-left:5px;">Post
      <div class="img">
...
function validate(){
  var flag=1;
   ...
   var length=form.title.value.length;
   var title=form.title.value;
    ...
    if(title==null || title==""){
        ...
        user="length should be less than 60";
        document.getElementById("title").innerHTML=user;
       flag=0;
       }
       else{
