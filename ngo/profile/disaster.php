...
<?php
  ...
  $sql2="SELECT u.full_name,u.emailid,u.mobile,p.field,p.message,p.mtime,p.title FROM userdata u,postfeed p WHERE p.uid=u.uid  AND p.field ='Disaster Management and relief'";
