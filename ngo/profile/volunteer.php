...
<?php
  ...
  $sql2="SELECT u.full_name,u.emailid,u.mobile,p.field,p.message,p.mtime,p.title FROM userdata u,postfeed p WHERE p.uid=u.uid AND p.uid!=$uid AND u.field ='Child Welfare'";
...
<div class="outp" style="float:left;">
  <form name=form  action="massage.php" onsubmit="return validate()" method="post">  
  <div class="top">
  ...
  <div class="title">
   ...
   <div class="text">
       ...
       <textarea name="tarea"  style="width: 100%; height:250px; border: 0px none;" placeholder="Write your massage here"></textarea>
  </div>
